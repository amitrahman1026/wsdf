...
//! Wireshark or tshark to load it upon startup. As of 4.4.x, you will need to rename the extension
//! to `.so` for Wireshark to [detect the plugin](https://gitlab.com/wireshark/wireshark/-/blob/release-4.4/wsutil/plugins.c?ref_type=heads#L123).
//!
//! You can use **Help › About Wireshark › Folders**
//! or `tshark -G folders` to find the default locations for plugins on your system.
//!
//! # Using derive
//!
